                        ...
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="main-img d-flex justify-content-center">
                                    ...
                                    <span v-else>
                                        <img :src="`/frontend/images/products/` + product.image" height="350"/>
                                    </span>
                                </div>
                        ...
                        <div class="single-block">
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    <img :src="`/frontend/images/blog/comment1.jpg`" alt="#">
                                ...
                                <div class="single-review">
                                    <img :src="`/frontend/images/blog/comment2.jpg`" alt="#">
                                    <div class="review-info">
                                ...
                                <div class="single-review">
                                    <img :src="`/frontend/images/blog/comment3.jpg`" alt="#">
                                    <div class="review-info">
